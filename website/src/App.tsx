...
function App() {
  ...
  return (
    <div data-theme={isDarkMode ? 'dark' : 'light'} className={`site-shell min-h-screen ${isDarkMode ? 'bg-[#0a0a0a] text-white' : 'bg-white text-[#121317]'} font-sans flex flex-col relative transition-colors duration-300`}>
