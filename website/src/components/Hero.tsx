    ...
    return (
        <div className="flex flex-col items-center justify-center text-center px-4">
            ...
            <div className="flex gap-4">
                ...
                <button className={`${isDarkMode ? 'text-white border-gray-600 hover:bg-gray-800' : 'text-[#1a73e8] border-[#dadce0] hover:bg-gray-100'} px-6 py-3 rounded-full font-medium transition-colors border`}>
                    Explore use cases
                </button>
            </div>
        </div>
